...
void main() {
  ...
  var pedro = Funcionario(nome: 'Pedro', cargo: gerente);
  var caio = Funcionario(nome: 'Caio', cargo: supervisor);
  var venda1 = Venda(valor: 100, cliente: cliente, funcionario: pedro);
  var venda2 = Venda(valor: 100, cliente: cliente, funcionario: caio);
